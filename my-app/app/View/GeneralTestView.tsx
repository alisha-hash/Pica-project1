                ...
                return (
                  <button key={opt} onClick={() => onAnswer(i)}
                    ...
                    <span className={`w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0 ${
                      selected ? "bg-[#00ffaa] text-gray-900" : d ? "bg-[#243044] text-gray-400" : "bg-gray-100 text-gray-600"
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-8 py-16">
        ...
        <div className="grid grid-cols-3 gap-5 w-full max-w-3xl">
          {steps.map(({ num, title, desc, done, active }) => (
            <div key={num} className={`rounded-2xl p-5 border transition ${
              active ? d ? "bg-[#1a2235] border-[#00ffaa]/40" : "bg-white border-teal-400 shadow"
              ...
              <div className="flex items-center gap-2 mb-3">
                <div className={`w-7 h-7 rounded-full flex items-center justify-center ${
                  done ? "bg-[#00ffaa]" : active ? "bg-[#f97316]" : d ? "bg-[#243044]" : "bg-gray-300"
                }`}>
                  {done
